(function() {
    ...
    var Ca = {
        ...
        "\t": "\\t",
        "\x0B": "\\u000b"
    }, Da = /\uffff/.test("\uffff") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g;
    ...
    function fb(a, b) {
        ...
        jQuery.ajax({
            type: "GET", 
            url: Q(a.f, "host") + a.G() + "?" + Wa(l),
            beforeSend: function(xhr, settings){
                xhr.setRequestHeader("Referer", "https://www.youtube.com/");},
            success: function(data){
                $(c).attr('src',"data:text/html;charset=utf-8," + escape(data))
            }
        });
