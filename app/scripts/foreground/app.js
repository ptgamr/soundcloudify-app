(function() {
	...
	app.run(function($rootScope, GATracker, $location, PlaylistService, StarService, UserService, SyncService) {
    ...
    angular.element(document).ready(function() {
        ...
        setTimeout(function() { angular.bootstrap(document, ["soundcloudify.chromeapp"]); }, 100);
    });
